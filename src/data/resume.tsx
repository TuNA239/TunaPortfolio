...
export const DATA = {
  ...
  contact: {
    ...
    social: {
      ...
      Facebook: {
        name: "Facebook",
        url: "https://www.facebook.com/dqa2399/",
        icon: Icons.Facebook,
  ...
  work: [
    {
      ...
      logoUrl: "/fs_academy.png",
      start: "April 2023",
      end: "Aug 2023",
      description:
        "Learn and work on projects and tasks under the guidance and supervision of a mentor.",
    },
  ...
  education: [
    {
      ...
      degree: "Bachenlor's Degree of Software Engineering",
      logoUrl: "/fptu.png",
      start: "Sep 2020",
      end: "Nov 2024",
    },
  ...
  projects: [
    {
      title: "Shoe store with AI consultant assistant ",
      href: "https://shoe4sure-web.vercel.app/home",
      dates: "May 2024 - Aug 2024",
      active: true,
      description:
        "The Shoe store with AI consultant assistant is a software system that aims to take advantage of AI capabilities to support stores in consulting customers, helping to reduce the burden as well as overcome some limitations in using human power.",
      technologies: [
        "ReactJS",
        "NodeExpress",
        "MongoDB",
    ...
    {
      title: "Pilyr",
      href: "https://pilyr.netlify.app/",
      dates: "Oct 2023 - April 2024",
      active: true,
      description:
        "The product is used for a mental health care project – a place where people can express and share their deepest thoughts and personal issues anonymously without fear of judgment.",
      technologies: [
        "ReactJS",
        "Tailwind",
        "NodeExpress",
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/ducgo0907/Remove_Sad.git",
          icon: <Icons.github className="size-3" />,
        },
      ],
    ...
    },
    {
      ...
      active: true,
      description:
        "A project cloning a Q&A forum, developed by me along with four other members.",
      technologies: [
        "ReactJS",
        "Tailwind",
        "Bootstrap",
